...
json_file_2 = '10_abilities INC 9G.json'  # Replace with your second JSON file path
output_file = '10_abilities FULL 9G.json'  # Replace with desired output file path
